...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        type.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chemicals", "Automotive", "Energy & Power", "Industrial", "Life Science", "Tech" }));
...
String conveert(String main_content) {
        ...
        for (int ii = 0; ii < splitted.length; ii++) {
            if ((splitted[ii]).contains("http://")) { // use more statements for
                ...
                System.out.println(splitted[ii]); //just checking the output
    ...
    String conveert2nd(String main_content) {
        ...
        return main_content.subSequence(0, 32) + " " + link;
                       ...
                       System.out.println("421 total : " + total);
                        ...
                        for (XWPFParagraph paragraph : paragraphList) {
                            ...
                            if (!"".equals(paragraph.getText())) {
                                ...
                                } else if ((main_iterate == 18 && !paragraph.getText().contains("Access Report ") || (main_iterate == 17 && doo && !paragraph.getText().contains("Access Report ")))) {
                                    first = paragraph.getText();
                                } else if (main_iterate >= 18) {
                                    if (paragraph.getText().contains("Purchase this Premium Report ")) {
